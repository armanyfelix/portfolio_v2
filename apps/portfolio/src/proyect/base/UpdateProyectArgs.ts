...
@ArgsType()
class UpdateProyectArgs {
  @Field(() => ProyectWhereUniqueInput, { nullable: false })
  where!: ProyectWhereUniqueInput;
  @Field(() => ProyectUpdateInput, { nullable: false })
  data!: ProyectUpdateInput;
}

export { UpdateProyectArgs as UpdateProyectArgs };
