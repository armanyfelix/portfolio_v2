...
const Footer: FC<Props> = () => {
  return (
    <footer className="footer footer-center rounded bg-primary bg-opacity-20 p-10 text-base-content shadow-xl backdrop-blur backdrop-brightness-90 backdrop-filter">
