  ...
  return (
    <>
      ...
      >
        <div>
          <Link href="/" legacyBehavior>
            ...
            >
              ...
              <path
                d="M11.5 19.5L20 1H21L30.5 19.5M30.5 0V20"
                stroke="black"
                strokeWidth="2"
              />
              <path
                d="M41.5 0.5L50.5 18.5H51.5L60.5 0.5"
                stroke="black"
                strokeWidth="2"
              />
        ...
        <div
          id="site-menu"
          className="flex flex-col z-50 sm:flex-row justify-between items-center"
        >
          <nav
          ...
          <button
            id="menuBtn"
            aria-label="menu"
            className={`p-0 hamburger block focus:outline-none ${
              open ? 'open' : ''
            }`}
      ...
      <section
        className={`${
          open
            ? 'right-0 w-full md:w-[50%] lg:w-[30%]'
            : 'translate-x-96 right-0'
        }
      ...
      >
        <button
          id="menuBtn"
          aria-label="menu"
          className={`mt-2 mr-6 hamburger block float-right ${
            open ? 'open' : ''
          }`}
          onClick={() => setOpen(!open)}
        >
        ...
        <nav
          className={` font-bold text-white flex flex-col space-y-5 mt-20 items-center`}
        >
          <Link
            onClick={() => setOpen(false)}
            href="#proyects"
